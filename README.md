...
3. Install [**Ethernet_Manager_Portenta_H7** library](https://platformio.org/lib/show/xxxxx/Ethernet_Manager_Portenta_H7) by using [Library Manager](https://platformio.org/lib/show/xxxxx/Ethernet_Manager_Portenta_H7/installation). Search for Ethernet_Manager_Portenta_H7 in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
